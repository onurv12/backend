<?php
	...
	require_once("manager/config.php");	// TODO: This might be a problem later, we have to solve. I think we should specify, that the user has to migrate some settings into his config file in his root folder.
	require "manager/PermissionManager.class.php";
